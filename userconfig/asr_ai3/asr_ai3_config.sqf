...
asr_ai3_skills_sets = [ // for each level: skilltype, [<min value>, <random value added to min>]
	...
	[	'general',[0.45,0.2],	'aiming',[0.05,0.2],	'spotting',[0.10,0.2]	],	// 7:  no military training
...
asr_ai3_skills_levels_units = [
	...
	["LOP_ISTS_OPF_Infantry_Engineer"],	// 1:  sf 1
	["LOP_ISTS_OPF_Infantry_TL"],	// 2:  sf 2 (recon units, divers and spotters)
	["LOP_ISTS_OPF_Infantry_SL"],	// 3:  regular 1 (regular army leaders, marksmen)
	["LOP_ISTS_OPF_Infantry_GL","LOP_ISTS_OPF_Infantry_AR_Asst"],	// 4:  regular 2 (regulars)
	["LOP_ISTS_OPF_Infantry_AR"],	// 5:  militia or trained insurgents, former regulars (insurgent leaders, marksmen)
	["LOP_ISTS_OPF_Infantry_Corpsman"],	// 6:  civilians with some military training (insurgents)
	["LOP_ISTS_OPF_Infantry_Rifleman_5","LOP_ISTS_OPF_Infantry_AT"],	// 7:  civilians without military training
	["LOP_ISTS_OPF_Infantry_Rifleman"],	// 8:  pilot 1 (regular)
	["LOP_ISTS_OPF_Infantry_Rifleman_6"],	// 9:  pilot 2 (insurgent)
	["LOP_ISTS_OPF_Infantry_Marksman"]	// 10: sniper 
];
